...
<sf:form action="/upload" method="post" enctype="multipart/form-data" modelAttribute="uploadPost">
	<div id="box">
    	<div id="photo">
        <img id="uploadedImage" title="<s:message code="post.add.photo"/>" src="/resources/images/Photos/addPhoto.png" class="addPhotoHover" onclick="document.getElementById('file').click();">
		<input type="file" style="display:none;" id="file" name="fileupload" accept="image/*" onchange="loadFile(event)"/>
        </div>
		<div id="photodetails">
            <div id="userbox">
                <img id="avatar" src="/resources/images/Icons/avatar.png"></img>
                <a id="nickname" href="profile/Maffashion">Maffashion</a>
            </div>
            <div id="description">
            	<p>Opis:</p>
            	<textarea name="description" id="descriptionInput" placeholder="Opis" rows="5" cols="80"></textarea>
            </div>
            <div id="products">
              <div id="product">
            ...
            <div style="color:red;text-align:center;font-size:20px;margin-top:20px;">
            ${error }
            </div>
		</div>
	</div>
